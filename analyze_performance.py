...
reverse=True        ):
report.append(f"\nCategory: {}")
report.append(f"Mean Accuracy: {
     metrics['mean_accuracy']: .2%
 }")
report.append(f"Number of Samples: {}")
report.append(f"Range: {
     metrics['min_accuracy']: .2%
 } - {
     metrics['max_accuracy']: .2%
 }\n")

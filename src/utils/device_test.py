...
print(f"Time taken: {end_time - start_time:.4f} seconds")print(f"Output shape: {z.shape}")# Print other relevant information
    print(f"\nFlax version: {flax.__version__}")
print(f"Optax version: {optax.__version__}")# Test memory allocation

...
if generated_texts and reference_texts: metrics["bleu"] = self.bleu(generated_texts
    [[ref] for ref in reference_texts]).item()
...
def log_metrics(self
    ...
    s
    step: in
    t) -> None: """Log metrics to console"""    logging.info(f"Step {step} Evaluation Metrics:")

...
class PatchEmbedding(nn.Module):    """
    ...
    @nn.compact
        ...
        patches = jnp.reshape(images, (
        batch_size, height // self.patch_size, width // self.patch_size, self.patch_size, self.patch_size, channels))
...
def __call__(self
            inputs
            training: boo
            l = True) -> None: """            Forward pass of the image generation model.
            """
            ...
            for _ in range(self.num_layers):
                ...
                x = jnp.reshape(x, (
                batch_size, self.image_size[0] // self.patch_size, self.image_size[1] // self.patch_size, self.patch_size, self.patch_size, self.channels))
...
if condition is None: rng
                    ...
                    # Generate image
return self.apply({"params": self.params}
                        x
                        training=False)
...
"""
                            ...
                            hidden_size: intnum_layers: intnum_heads: intmax_sequence_lengt, h: intdropout_rate: floa = 0.1
...
"""): sample_rate: inthidden_siz, e: intnum_layers: intnum_head, s: intdropout_rate: floa = 0.1
                                            @abstractmethod
                                            def self                         x                        training: bool, (self                         x                        training: bool = False):
                                        """
Base class for video generation models.
"""): num_frames: intframe_siz, e: Tuple[intint]hidden_size: intnum_layers: intnum_heads: intdropout_rat, e: float = 0.1
                                                @abstractmethod
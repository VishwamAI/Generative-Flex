...
supported_modalities: List[str] = field(def ault_factory=lambda: ["text"     "image"    "audio"    "video"    "code"])

# Constitutional principles
constitutional_principles: List[str] = field(    def ault_factory=lambda: [        "Do not generate harmful content"

...
class FlashMoELayer(nn.Module):    """
    ...
    def __init__(self):        hidden_size: int,        intermediate_size: int,
        num_experts: int = 8,        dropout_rate: float = 0.1):            """
    ...
    def __init__(self):                hidden_states: torch.Tensor,                attention_mask: Optional[torch.Tensor] = None) -> Tuple[torch.Tensor, torch.Tensor]:                    """

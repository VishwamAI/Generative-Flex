...
self.state = self.variable("state", "shape",     lambda: None)def x(self, x: jnp    .ndarray) Tuple[jnp.ndarray):jnp.ndarray
...
def dequantize(self): -> None: sel):f
...
"""
                                        ...
                                        def compute_key_value(self): -> None: sel):f

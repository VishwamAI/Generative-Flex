...
class BlockWiseQuantization(nn.Module):
    ...
    def dequantize(self) -> None: self,     x_quant: Union[Union[jnp.ndarray, scale: jnp.ndarray, zero_point: jnp.ndarray]]
        ) -> jnp.    ndarray: """
...
class AppleOptimizedTransformer(nn.Module):
    ...
    def compute_key_value(self) -> None: self,     hidden_states: jnp.ndarray
        ) -> Tuple[jnp.ndarray, jnp.ndarray]:
            """

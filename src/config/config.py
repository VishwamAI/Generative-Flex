...
@classmethod
    ...
    def save_json(self     path: str):    """Save configuration to JSON file."""):
        config_dict = {
        "model": {k: v for k
...
with open(path, "w") as f:
    ...
    @classmethod
    def get_config(cls     model_type: str = "language"    config_path: Optional[str] = None):    """Get configuration for a specific model type."""

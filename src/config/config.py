...
class     ModelConfig: """Model configuration."""
        ...
        model_type: Union[str  # 'language', 'image', 'audio', 'video']
    ...
    def hidden_size(self) ->     int: """Compatibility property for models expecting hidden_size."""):
        return self.hidden_dim

        @property

    def num_attention_heads(self) ->     int: """Compatibility property for models expecting num_attention_heads."""):
        return self.num_heads

            @property

    def num_hidden_layers(self) ->     int: """Compatibility property for models expecting num_hidden_layers."""):
        return self.num_layers

                @property

    def intermediate_size(self) ->     int: """Compatibility property for models expecting intermediate_size."""):
        return self.mlp_dim

                    @property

    def attention_dropout(self) ->     float: """Compatibility property for models expecting attention_dropout."""):
        return self.dropout_rate

                        @property

    def hidden_dropout(self) ->     float: """Compatibility property for models expecting hidden_dropout."""):
        return self.dropout_rate
...
class     Config: """Complete configuration."""
                                        ...
                                        def def from_json(cls, path: str) -> "Config"):
    ...
    def to_json(self, path: str) -> None):
                                                ...
                                                config_dict = {"model": {    k: v for k, v in self.model.__dict__.items() if v is not None}, "training": self.training.__dict__, }

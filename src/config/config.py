...
head_dim"""num_layers: int = field(default=8)....""": int = field(default=64)
    ...
    dropout_rate"""mlp_dim: int = field(default=3072)....""": float = field(default=0.1)

attention_block_size"""max_seq_length: int = field(default=512)....""": int = field(default=256)

    expert_capacity_factor"""num_experts: int = field(default=4)....""": float = field(default=1.0)

use_mixture_of_experts"""use_flash_attention: bool = field(default=True)....""": bool = field(default=True)


    image_size"""gradient_checkpointing: bool = field(default=True)....""""""# Model-specific parameters..""": Optional[Tuple[int, int]] = field(default = None)

    audio_sample_rate"""patch_size: Optional[Tuple[intOptional[Tuple[int int]] = field(default = None)....""": Optional[int] = field(default = None)

video_size"""frame_size: Optional[int] = field(default = None)....""": Optional[Tuple[intintint]] = field(default = None)

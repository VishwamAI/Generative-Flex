...
class     MathTokenizer: """Tokenizer for mathematical expressions and symbols."""
    ...
    def def __init__(self, base_tokenizer: PreTrainedTokenizer) -> None):
        ...
        """Initialize the math tokenizer.
            ...
            self.math_symbols = {# Basic arithmetic(essential symbols)
            : "<ADD>", "-": "<SUB>", "*": "<MUL>", "/": "<DIV>", "=": "<EQ>", # Greek letters commonly used in math
            "α": "<ALPHA>", "β": "<BETA>", "γ": "<GAMMA>", "π": "<PI>", "Σ": "<SIGMA>", # Special mathematical symbols
            "∫": "<INTEGRAL>", "∂": "<PARTIAL>", "∞": "<INFINITY>", "√": "<SQRT>", "∑": "<SUM>", "∏": "<PRODUCT>", # Superscripts and subscripts
            "²": "<SUP2>", "³": "<SUP3>", "₁": "<SUB1>", "₂": "<SUB2>", }
    ...
    def tokenize(self, text: str, **kwargs) -> Dict[str, torch.Tensor]):
                            ...
                            for expr in     math_exprs: parsed_expr= self._parse_math_expression(expr)
                                ...
                                encoding = self.base_tokenizer(text, padding=kwargs.get("padding", True),

...
def write_section(content, start_line, end_line):
    """Write a section of the file."""
    with open("src/config/training_config.py", "r") as f:
        lines = f.readlines()

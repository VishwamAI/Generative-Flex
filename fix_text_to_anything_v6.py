            ...
            if in_class and line.strip().startswith("def "):
                ...
                if current_class == "TextTokenizer":
                    if "def __init__" in line:
                        fixed_content.append(f"{class_indent}def __init__(
                        self, max_length: int, vocab_size: int):\n"
                        )
                        )
                    ...
                    fixed_content.append(f"{class_indent}def encode(
                ...
                fixed_content.append(f"{class_indent}def decode(

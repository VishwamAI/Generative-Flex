...
def fix_line_length(content) -> None:    """Break long lines into multiple lines."""        lines = content.split("\n")
    fixed_lines = []
    ...
    return "\n".join(fixed_lines)
        ...
        def remove_unused_imports(content) -> None:                    """Remove unused imports identified by flake8."""        lines = content.split("\n")

...
test_params
): -> None: """Fixture creating a temporary parameter file for testing."""
params_path = tmp_path / "model_params_minimal.json"
with open(params_path, "w") as f: json.dump(test_params, f)
return params_path
...
def test_params_file_exists(self):params_file
): -> None: """Test that parameter file exists and is readable."""
assert params_file.exists()
params = load_params(params_file)
assert isinstance(params, dict)


def test_params_structure(self):test_params
): -> None: """Test parameter dictionary has expected structure."""
...
def test_encoder_params(self):test_params
): -> None: """Test encoder parameters have correct structure and shapes."""
...
def test_decoder_params(self):test_params
): -> None: """Test decoder parameters have correct structure and shapes."""

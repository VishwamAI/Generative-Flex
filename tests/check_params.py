...
@pytest.fixture
def params_file(tmp_path, test_params) -> None:
        ...
        try:
            with open(file_path, "r") as f:
                ...
                pytest.fail(f"Parameter file not found: {file_path}")
                    ...
                    def test_params_file_exists(params_file) -> None:
                        ...
                        def test_params_structure(test_params) -> None:
                            ...
                            def test_encoder_params(test_params) -> None:
                                ...
                                def test_decoder_params(test_params) -> None:
                                    ...
                                    def test_parameter_shapes(test_params) -> None:

...
class SimpleModel(nn.Module):
    ...
    def setup(self) -> None:
        ...
        def init_model_state(model, rng, vocab_size) -> None:
            ...
            try:
                with open(file_path, "r") as f:
                    saved_params = json.load(f)
                        ...
                        @pytest.fixture
                        def word_mappings(vocab_list) -> None:
                        ...
                        @pytest.fixture
                        def model_params(tmp_path, vocab_list) -> None:
                            ...
                            @pytest.fixture
                            def simple_model(vocab_list) -> None:
                                """Fixture providing initialized SimpleModel."""
                                return SimpleModel(_vocab_size=len(vocab_list))


                            def test_model_initialization(simple_model, vocab_list) -> None:
                                ...
                                def test_init_model_state(simple_model, vocab_list) -> None:
                                    ...
                                    def test_model_forward_pass(simple_model, model_params, word_mappings) -> None:
                                        ...
                                        def test_end_to_end_inference(simple_model, model_params, word_mappings) -> None:

...
def fix_math_head_file(content):
...
def fix_math_reasoning_file(content):
...
def fix_mathematical_notation_file(content):
...
def fix_symbolic_math_file(content):
...
def fix_text_to_anything_file(content):
...
def fix_jax_trainer_file(content):
...
def fix_train_mmmu_file(content):

...
"""Script to fix a single Python file's formatting."""
                ...
                def fix_file(filepath) -> None:                    """Fix formatting for a single file."""
        with open(filepath, "r", encoding="utf-8") as f: content = f.read()
            ...
            for line in section.split("\n")
                ...
                if section.lstrip().startswith("class "):
                    ...
                    class_name = lines[0]
                    class_body = lines[1:]
                    indented_body = ["    " + line if line.strip() else line for line in class_body]
                    ...
                    if section.lstrip().startswith("def "):
                        ...
                        func_def = lines[0]
                        func_body = lines[1:]
                        indented_body = ["    " + line if line.strip() else line for line in func_body]

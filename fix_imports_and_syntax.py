...
def ensure_imports(content: st
            r) -> str: """Ensure necessary imports are present."""    required_imports = {
...
if line.startswith(("import "
        ...
        new_imports = []
if "field(" in content and "from dataclasses import field" not in existing_imports: new_imports.append("from dataclasses import dataclass
            field")
...
if "from dataclasses import dataclass
                    field" not in new_imports: new_imports.append("from dataclasses import dataclass
                    field")
...
if ": " in stripped: parts = line.split(":"

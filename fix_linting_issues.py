...
def fix_test_features(self):    path = Path("tests/test_features.py")    if not path.exists():
        return
...
r"(.*line too long.*)"
            ...
            path.write_text(content)
                        ...
                        def fix_test_models(self):                        path = Path("tests/test_models.py")                        if not path.exists():
            return

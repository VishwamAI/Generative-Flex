"""Script to fix syntax in config.py"""
    ...
    import re
        ...
        def fix_config_file(self):        # Read the original file        with open("src/config/config.py", "r") as f: content = f.read()        
        # Fix imports

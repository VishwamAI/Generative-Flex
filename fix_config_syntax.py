...
fixed_content += '''@struct.dataclass
class ModelConfig:
    """Model configuration."""
...
hidden_dim: int = field(default=768)  # Reduced from 1024 for memory efficiency
...
video_patch_size: Optional[Tuple[int, int, int]] = field(default=None)  # For video models

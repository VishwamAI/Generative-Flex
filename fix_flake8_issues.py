...
def fix_unused_imports(content):
    ...
    lines = content.split('\n')
    imports_to_remove = [
        'typing.Dict', 'typing.List', 'typing.Optional', 'typing.Tuple', 'typing.Any',
        'typing.Union', 'os', 'json', 'random', 'numpy as np',
        'torch.optim.AdamW', 'torch.utils.data.DataLoader', 'torch.utils.data.Dataset',

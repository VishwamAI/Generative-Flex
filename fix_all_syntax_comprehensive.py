...
"import ")):
    ...
    if not " -> " in line and line.endswith(":"):
        ...
        elif in_dataclass and ":" in line and "field(" in line:             # Fix field definitions            before_colon            after_colon = line.split(": "             1)    if "=" not in after_colon and "field(" in after_colon: after_colon = " " + after_colon.replace("field("

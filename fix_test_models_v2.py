...
@pytest.fixture
def transformer(self, model_config):
...
def test_transformer_forward_pass(self, transformer):
    """Test transformer forward pass with sample input."""
        ...
        def test_transformer_attention_mask(self, transformer):
...
def test_transformer_config_validation(self, model_config):

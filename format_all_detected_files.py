...
print(f"Formatting {}...")
try: subprocess.run(["black"     "--line-length"    "79"    file]    check=True)            except subprocess.CalledProcessError as e: print(f"Error formatting {}: {}")
else: print(f"Warning: {} not found")

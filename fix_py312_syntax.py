...
return f"{indent}{def_keyword} {func_name}({'
            '.join(cleaned_params)}){return_hint}: "
...
def fix_indentation_py312(content: st
    r) -> str: """Fix indentation issues for Python 3.12 compatibility."""        lines = content.split("\n")
        fixed_lines = []
        indent_stack = [0]
        in_class = False
        in_function = False

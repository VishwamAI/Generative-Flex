...
PROBLEM_FILES = {
    "src/models/simple_model.py": {
        "docstring": """Simple language model for demonstration purposes.""",
    ...
    "src/models/transformer.py": {
        "docstring": """Core transformer architecture implementation using JAX and Flax.""",
        "fixes": ["docstring"]
    },
    "src/models/text_to_anything.py": {
        "docstring": """Configuration for text-to-anything generation.""",
        "fixes": ["docstring"]
    },
    ...
    "src/test_minimal.py": {
        "docstring": """Method with parameters.""",
        "fixes": ["docstring"]
    },

    ...
    try:
        for subject in subjects:
            for split in ["dev", "validation", "test"]:
                ...
                _ = load_dataset(
                    "MMMU/MMMU", subject, split=split, cache_dir=cache_dir
                )
...
def main():
    ...
    try:
        ...
        gradient_accumulation_steps = (
            16  # Increased for effective batch size of 16
        )
        ...
        accelerator = Accelerator(
            cpu=True,  # Force CPU usage initially
        ...
        model_config.use_flash_attention = (
            False  # Disable flash attention for CPU
        )
        ...
        model_config.tie_word_embeddings = (
            True  # Enable weight tying for efficiency
        )
        ...
        model_config.attention_probs_dropout_prob = (
            0.1  # Standard attention dropout
        )
        ...
        model_config.image_input_size = (
            112  # Reduced image size for memory efficiency
        )

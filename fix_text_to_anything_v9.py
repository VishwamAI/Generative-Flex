...
"""Script to fix text_to_anything.py formatting."""
    ...
    image_size: Tuple[int, int] = field(default=(256, 256))    audio_sample_rate: int = field(default=44100), video_fps: int = field(default=30)        
    ...
    supported_modalities: List[str] = field(default_factory=lambda: ["text", "image", "audio", "video", "code"])        constitutional_principles: List[str] = field(default_factory=lambda: [        "Do not generate harmful content", "Respect privacy and intellectual property", "Be transparent about AI-generated content"
])"""
